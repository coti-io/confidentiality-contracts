...
// =========== 1 bit operations ==============
    ...
    function validateCiphertext(itBool memory input) internal view returns (gtBool) {
    ...
    function not(gtBool a) internal view returns (gtBool){
         return  gtBool.wrap(ExtendedOperations(MPC_PRECOMPILE).
 ...
 // =========== 8 bit operations ==============
    ...
    function validateCiphertext(itUint8 memory input) internal view returns (gtUint8) {
    ...
    function transfer(gtUint8 a, gtUint8 b, gtUint8 amount) internal view returns (gtUint8, gtUint8, gtBool){
 ...
 // =========== 16 bit operations ==============
    ...
    function transfer(gtUint16 a, gtUint16 b, gtUint16 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint32 b, gtUint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
...
// =========== 64 bit operations ==============
    ...
    function transfer(gtUint64 a, gtUint64 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transferWithAllowance(gtUint64 a, gtUint64 b, gtUint64 amount, gtUint64 allowance) internal view returns (gtUint64, gtUint64, gtBool, gtUint64){
    ...
    function transferWithAllowance(gtUint64 a, gtUint64 b, uint64 amount, gtUint64 allowance) internal view returns (gtUint64, gtUint64, gtBool, gtUint64){
        (uint256 new_a, uint256 new_b, uint256 res, uint256 new_allowance) = ExtendedOperations(MPC_PRECOMPILE).
...
// =========== 64 bit operations ==============
    ...
    function transfer(gtUint8 a, gtUint8 b, uint8 amount) internal view returns (gtUint8, gtUint8, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint16 b, uint16 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint16 b, uint16 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint8 b, uint16 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint32 b, uint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint32 b, uint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint8 b, uint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint32 b, uint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint16 b, uint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint64 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint64 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint8 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint64 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint16 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint64 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint32 b, uint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
 ...
 // =========== 8 - 16 bit operations ==============
    ...
    function mux(gtBool bit, gtUint16 a, gtUint8 b) internal view returns (gtUint16){
         return gtUint16.wrap(ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint16 b, gtUint16 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint8 b, gtUint16 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint16 b, gtUint8 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint8 b, gtUint8 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint16 b, gtUint8 amount) internal view returns (gtUint16, gtUint16, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function mux(gtBool bit, gtUint32 a, gtUint8 b) internal view returns (gtUint32){
         return gtUint32.wrap(ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint32 b, gtUint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint8 b, gtUint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint32 b, gtUint8 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint8 b, gtUint8 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint32 b, gtUint16 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint8 b, gtUint16 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint32 b, gtUint8 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function mux(gtBool bit, gtUint32 a, gtUint16 b) internal view returns (gtUint32){
         return gtUint32.wrap(ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint32 b, gtUint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint16 b, gtUint32 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint32 b, gtUint8 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint16 b, gtUint8 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint32 b, gtUint16 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint16 b, gtUint16 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint32 b, gtUint16 amount) internal view returns (gtUint32, gtUint32, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
...
// =========== 8 - 64 bit operations ==============
    ...
    function mux(gtBool bit, gtUint64 a, gtUint8 b) internal view returns (gtUint64){
         return gtUint64.wrap(ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint64 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint8 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint64 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint8 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint8 a, gtUint64 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint8 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
     ...
     function transfer(gtUint8 a, gtUint64 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint8 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint64 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function mux(gtBool bit, gtUint64 a, gtUint16 b) internal view returns (gtUint64){
         return gtUint64.wrap(ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint64 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint16 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint64 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint16 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint64 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint16 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint16 a, gtUint64 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint16 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint64 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function mux(gtBool bit, gtUint64 a, gtUint32 b) internal view returns (gtUint64){
         return gtUint64.wrap(ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint64 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint32 b, gtUint64 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint64 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint32 b, gtUint8 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint64 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint32 b, gtUint16 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint32 a, gtUint64 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint32 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
    ...
    function transfer(gtUint64 a, gtUint64 b, gtUint32 amount) internal view returns (gtUint64, gtUint64, gtBool){
        (uint256 new_a, uint256 new_b, uint256 res) = ExtendedOperations(MPC_PRECOMPILE).
